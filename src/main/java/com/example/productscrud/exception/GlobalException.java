...
public class GlobalException {
    ...
    @ExceptionHandler(com.example.crud.exception.NotFoundException.class)
    public ResponseEntity<ProblemDetail> notFoundException(com.example.crud.exception.NotFoundException e) {
        return problemDetailResponseEntity(e.getMessage(), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(com.example.crud.exception.BadRequestException.class)
    public ResponseEntity<ProblemDetail> badRequestException(com.example.crud.exception.BadRequestException e) {
